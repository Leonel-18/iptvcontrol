...
/**
 * Proveedores registrados — sección dentro de Configuración (`/settings`).
 *
 ...
 * Vive dentro de Configuración porque comparte el mismo objeto de datos que la
 * conexión, y así se evita redundancia entre pantallas.
 */
          ...
          {licencias.isLoading ? (
            ...
            <>
              ...
              <p className="mt-3 text-xs texto-suave">
                Licencias consultadas el {formatearFechaHora(licencias.data.consultado_en)}.
              </p>
            </>
          )}
        </CardContent>
