# Graph Report - iptvcontrol-opencode  (2026-08-24)

## Corpus Check
- 208 files · ~130,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1815 nodes · 4229 edges · 119 communities (86 shown, 33 thin omitted)
...
Cohesion: 0.06
Nodes (15): AuditService, Injectable, TeamMemberGuard, Injectable, RequestContextMiddleware, Injectable, RequestContextService, Injectable (+7 more)
...
Cohesion: 0.11
Nodes (5): CryptoService, Injectable, TransactionClient, IdentificadoresService, Injectable
...
Cohesion: 0.11
Nodes (20): RegistroAuditoria, RequestContext, CrearCuentaOpciones, SinCapacidadEnCuentaError, ClasificacionDispositivoProveedor, DispositivoInventarioDto, InventarioProveedorDto, ConfiguracionProveedorResuelta (+12 more)
...
Cohesion: 0.10
Nodes (22): DialogContent(), Field(), Textarea, AddDeviceDialog(), ApiError, armarCabeceras(), construirUrl(), descargarCsv() (+14 more)

### Community 32 - "ColaProveedorService"
Cohesion: 0.12
Nodes (14): DashboardModule, Module, DashboardService, Injectable, DatosCerrarCuenta, DatosEliminarDispositivo, DatosReconciliarDispositivos, DatosSincronizarContadoresVenta (+6 more)
...
Cohesion: 0.07
Nodes (33): ClientesService, Injectable, ActualizarRevendedoraDto, CambiarModalidadDto, CrearRevendedoraDto, ListarRevendedorasQueryDto, ApiProperty, ApiPropertyOptional (+25 more)
...
### Community 37 - "api"
Cohesion: 0.14
Nodes (34): CustomerStatusBadge(), ResellerStatusBadge(), TeamMemberStatusBadge(), AppLayout(), NotFound(), RequiereSesion(), SoloOperador(), SoloRevendedora() (+26 more)
...
Cohesion: 0.20
Nodes (17): tonoPorEstado, accountStatusLabels, customerIntakeLabels, customerStatusLabels, deviceBindingHelp, deviceBindingLabels, deviceStatusHelp, deviceStatusLabels (+9 more)
...
Cohesion: 0.09
Nodes (34): ALTURAS_BARRA, CapacityMeter(), OcupacionCuenta, DetailRow(), DeviceStatusBadge(), DeviceTypeBadge(), SecretValue(), ItemMenu (+26 more)

### Community 46 - "CommercialPlanList.tsx"
Cohesion: 0.26
Nodes (24): AccountStatusBadge(), CopyableId(), ExportCsvButton(), PageHeader(), Select(), Card(), EmptyState(), Input (+16 more)

### Community 47 - "CustomerDetail.tsx"
Cohesion: 0.15
Nodes (30): HealthBadge(), Metric(), Alert(), Badge(), BadgeProps, badgeVariants, BotonProps, botonVariants (+22 more)
...
Cohesion: 0.08
Nodes (28): ProviderDeviceClassBadge(), CardFooter(), EstadoFormulario, INICIAL, MetodoAlta, PASOS, customerIntakeHelp, Account (+20 more)
...
Cohesion: 0.12
Nodes (19): CoincidenciaGestionExterna, armarCategoria(), calcularCapacidad(), CapacidadCategoria, contarDispositivosCliente(), contarOcupados(), contarVentasActivas(), CuentaCapacidadInput (+11 more)
...
Cohesion: 0.25
Nodes (9): CurrentUser, Roles(), SoloOperador(), SoloRevendedor(), ColumnaCsv, generarCsv(), responderCsv(), Fila (+1 more)
...
- **Why does `PrismaService` connect `RequestContextService` to `ColaProveedorService`, `CrearModalidadDto`, `revendedoras.service.ts`, `TeamMembersService`, `clientes.service.ts`, `Auth0ManagementService`, `CryptoService`, `PaginationQueryDto`, `app.module.ts`, `Instructivo — Cargar IPTVControl en OpenCode`, `HealthController`, `cuentas.mapper.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `RequestContextService` connect `RequestContextService` to `ColaProveedorService`, `CrearModalidadDto`, `revendedoras.service.ts`, `TeamMembersService`, `Auth0ManagementService`, `CryptoService`, `PaginationQueryDto`, `SoloRevendedor`, `app.module.ts`, `generarCsv`, `Instructivo — Cargar IPTVControl en OpenCode`, `HttpExceptionFilter`, `cuentas.mapper.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `AuditService` connect `RequestContextService` to `ColaProveedorService`, `CrearModalidadDto`, `revendedoras.service.ts`, `Auth0ManagementService`, `CryptoService`, `app.module.ts`, `Instructivo — Cargar IPTVControl en OpenCode`, `cuentas.mapper.ts`?**
