...
## Corpus Check
- 208 files · ~130,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1815 nodes · 4229 edges · 120 communities (87 shown, 33 thin omitted)
...
Cohesion: 0.14
Nodes (26): CustomerStatusBadge(), DetailRow(), DeviceStatusBadge(), DeviceTypeBadge(), SecretValue(), tonoPorEstado, AddDeviceDialog(), DeviceDetailData (+18 more)
...
Cohesion: 0.15
Nodes (13): @eslint/js, devDependencies, eslint, @eslint/js, tailwindcss, @types/react-dom, typescript-eslint, vite (+5 more)
